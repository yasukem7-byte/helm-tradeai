    ...
    >
      ...
      {apiKey && (
        <>
          {/* ── スレッドサイドバー ── */}
          {sidebarOpen && (
            <div className="w-16 flex-shrink-0 flex flex-col border-r border-[#2a2e39] bg-[#161b27]">
              {/* 新規ボタン */}
              <button
                onClick={newThread}
                className="flex items-center justify-center gap-0.5 py-1.5 px-1 text-[8px] text-blue-400 hover:bg-[#1e2535] border-b border-[#2a2e39] transition-colors"
              >
